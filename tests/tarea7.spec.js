...
describe('Tarea7', function() {
  ...
  it('Tarea7', async function() {
    ...
    await driver.findElement(By.id("multiply-button")).click();
    await driver.findElement(By.css(".button-group > button:nth-child(1)")).click();

    await driver.findElement(By.id("divide-button")).click();
    await driver.findElement(By.css(".button-group > button:nth-child(1)")).click();
  });
});
